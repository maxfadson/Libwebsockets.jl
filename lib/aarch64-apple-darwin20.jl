...
const LWS_PROTOCOL_LIST_TERM = [Ptr{Cvoid}(0), Ptr{Cvoid}(0), Cint(0), Cint(0), Cint(0), Ptr{Cvoid}(0), Cint(0)]
...
const LWS_ILLEGAL_HTTP_CONTENT_LEN = lws_filepos_t(typemax(UInt64))
